...
// href : http://localhost:5500/index.html?type=listing&page=2#title / -> http의 모든 값 (주소)을 가지고 옴
// protocol : http: / -> 통신 규약 (http) 만 가지고 옴
// host : localhost:5500
// port : 5500
// search : ?type=listing&page=2 / -> params (쿼리문, 이부분이 빽엔드 부분으로 넘어가짐)
// hash : #title / ->
...
// list의 값만 가져오는 방법 (쇼핑몰에서 상품 가져오기, 상품태그)
